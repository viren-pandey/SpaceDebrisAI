      ...
      <div className="dash-page">
        ...
        {activeTab === "overview" && (
          <div>
            ...
            <div className="profile-info-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
              <div className="profile-info-card">
                ...
                <div className="info-row"><span className="info-label">User ID</span><span className="info-value">#{user?.id}</span></div>
              </div>
              <div className="profile-info-card">
                <h3>API Keys</h3>
                <div className="info-row"><span className="info-label">Active Keys</span><span className="info-value">{keys.filter(k => k.is_active).length}</span></div>
                <Link to="/dashboard/api-keys" className="dash-link">Manage Keys →</Link>
              </div>
              <div className="profile-info-card">
                <h3>Quick Actions</h3>
        ...
        {activeTab === "api-keys" && (
          <div>
            <div className="dash-welcome" style={{ flexDirection: "row", justifyContent: "space-between" }}>
              <h1>API Keys</h1>
